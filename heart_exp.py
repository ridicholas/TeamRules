...
train_conf2[np.where((team2.data_model_dict['Xtrain']['age54.0'] == 0) | (team2.data_model_dict['Xtrain']['sex_Male'] == 0))] = 0.8
train_conf2[np.where((team2.data_model_dict['Xtrain']['age54.0'] == 1) & (team2.data_model_dict['Xtrain']['sex_Male'] == 1))] = 0.2
val_conf2[np.where((team2.data_model_dict['Xval']['age54.0'] == 0) | (team2.data_model_dict['Xval']['sex_Male'] == 0))] = 0.8
val_conf2[np.where((team2.data_model_dict['Xval']['age54.0'] == 1) & (team2.data_model_dict['Xval']['sex_Male'] == 1))] = 0.2

test_conf2[np.where((team2.data_model_dict['Xtest']['age54.0'] == 0) | (team2.data_model_dict['Xtest']['sex_Male'] == 0))] = 0.8
