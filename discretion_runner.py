...
def run(team1, team2, team3, folder, team_info):
    ...
    folder = folder + f'_len{maxlen}_disc' 
    ...
    for run in range(0, numRuns):
        ...
        for data_to_use in data_size_list:
            ...
            if 'team1' in whichTeams:
                ...
                if data_to_use=='perfect':
                    team1.train_confidence_model(data_to_use)
                else:
                    team1.train_confidence_model(setting_type, data_to_use)
                team1.train_mental_error_boundary_model()
                if setting_type=='learned' and data_to_use!='perfect':
                    auc_dict['team1'][run][data_to_use] = team1.train_ADB_model(data_to_use)
                    team1.set_fA(team1.trained_ADB_model_wrapper)
                else:
                    auc_dict['team1'][run][data_to_use] = 1
            ...
            if 'team2' in whichTeams:
                ...
                if data_to_use=='perfect':
                    team2.train_confidence_model(data_to_use)
                else:
                    team2.train_confidence_model(setting_type, data_to_use)
                
                team2.train_mental_error_boundary_model()
                if setting_type=='learned' and data_to_use!='perfect':
                    auc_dict['team2'][run][data_to_use] = team2.train_ADB_model(data_to_use)
                    team2.set_fA(team2.trained_ADB_model_wrapper)
                else:
                    auc_dict['team2'][run][data_to_use] = 1
            ...
            if 'team3' in whichTeams:
                ...
                team3.set_training_params(Niteration, Nchain, Nlevel, Nrules, supp, maxlen, protected, budget, sample_ratio,
                                            ...
                                            beta, iters, fairness_reg, contradiction_reg, fA, force_complete_coverage=False, asym_loss = asym_loss, fair_feat=None)
                if data_to_use=='perfect':
                    team3.train_confidence_model(data_to_use)
                else:
                    team3.train_confidence_model(setting_type, data_to_use)
                
                team3.train_mental_error_boundary_model()
                if setting_type=='learned' and data_to_use!='perfect':
                    auc_dict['team3'][run][data_to_use] = team3.train_ADB_model(data_to_use)
                    team3.set_fA(team3.trained_ADB_model_wrapper)
                else:
                    auc_dict['team3'][run][data_to_use] = 1
            ...
            if 'team1' in whichTeams:
                ...
                team1.full_hyrs_results.to_pickle('{}/data_{}_team1_hyrs_filtered_run{}.pkl'.format(folder,  data_to_use, run))
            
                team1.full_tr_results.to_pickle('{}/data_{}_team1_tr_filtered_run{}.pkl'.format(folder,  data_to_use, run))

                team1.full_hyrs_results_val.to_pickle('{}/val_data_{}_team1_hyrs_filtered_run{}.pkl'.format(folder,  data_to_use, run))
            
                team1.full_tr_results_val.to_pickle('{}/val_data_{}_team1_tr_filtered_run{}.pkl'.format(folder,  data_to_use, run))

                with open('{}/data_{}_team1_tr_results_run{}.pkl'.format(folder,  data_to_use, run), 'wb') as outp:
                    pickle.dump(team1.tr_results, outp, pickle.HIGHEST_PROTOCOL)
                outp.close()
                
                with open('{}/data_{}_team1_hyrs_results_run{}.pkl'.format(folder,  data_to_use, run), 'wb') as outp:
            ...
            if 'team2' in whichTeams:
                ...
                team2.full_hyrs_results.to_pickle('{}/data_{}_team2_hyrs_filtered_run{}.pkl'.format(folder,  data_to_use, run))
                team2.full_tr_results.to_pickle('{}/data_{}_team2_tr_filtered_run{}.pkl'.format(folder,  data_to_use, run))
                team2.full_hyrs_results_val.to_pickle('{}/val_data_{}_team2_hyrs_filtered_run{}.pkl'.format(folder,  data_to_use, run))
                team2.full_tr_results_val.to_pickle('{}/val_data_{}_team2_tr_filtered_run{}.pkl'.format(folder,  data_to_use, run))

                with open('{}/data_{}_team2_tr_results_run{}.pkl'.format(folder,  data_to_use, run), 'wb') as outp:
                    pickle.dump(team2.tr_results, outp, pickle.HIGHEST_PROTOCOL)
                outp.close()

                with open('{}/data_{}_team2_hyrs_results_run{}.pkl'.format(folder,  data_to_use, run), 'wb') as outp:
            ...
            if 'team3' in whichTeams:
                ...
                team3.full_hyrs_results.to_pickle('{}/data_{}_team3_hyrs_filtered_run{}.pkl'.format(folder,  data_to_use, run))
                team3.full_tr_results.to_pickle('{}/data_{}_team3_tr_filtered_run{}.pkl'.format(folder,  data_to_use, run))

                team3.full_hyrs_results_val.to_pickle('{}/val_data_{}_team3_hyrs_filtered_run{}.pkl'.format(folder,  data_to_use, run))
                team3.full_tr_results_val.to_pickle('{}/val_data_{}_team3_tr_filtered_run{}.pkl'.format(folder,  data_to_use, run))

                with open('{}/data_{}_team3_tr_results_run{}.pkl'.format(folder,  data_to_use, run), 'wb') as outp:
                    pickle.dump(team3.tr_results, outp, pickle.HIGHEST_PROTOCOL)
                outp.close()

                with open('{}/data_{}_team3_hyrs_results_run{}.pkl'.format(folder, data_to_use, run), 'wb') as outp:
    ...
    with open('{}/auc_dict.pkl'.format(folder), 'wb') as outp:
        pickle.dump(auc_dict, outp, pickle.HIGHEST_PROTOCOL)
    outp.close()
    print('finally done.')